...
def test_handleFriendsCount_negative():
    stdout = handleFriendsCount("-5") == False
...
def test_handleCalorieStats_invalid_input():
    ...
    assert handleCalorieStats(user_input) == False
...
def test_handleJuiceNameSequene_invalid_input():
    user_input = "123"
    assert handleJuiceNameSequene(3, user_input) == False

def test_handleCalorieIntakeForFriend_valid_input():
    user_input = "50"
    assert handleCalorieIntakeForFriend(user_input) == 50

def test_handleCalorieIntakeForFriend_invalid_input():
    user_input = "invalid"
    assert handleCalorieIntakeForFriend(user_input) == False